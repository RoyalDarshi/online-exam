...
import { Exam } from '../lib/supabase'; // We can reuse the types, or move them to a generic types file
...
export function StudentDashboard() {
  ...
  async function loadExams() {
    try {
      // Go Backend automatically filters for 'is_active=true' based on student role
    ...
    return (
      <ExamTaking
        ...
        onComplete={() => {
          ...
          loadExams(); // Refresh list to update any attempt history if you add that later
        }}
